...
<head>
    ...
    <title>Reset Password | NACPDEAN</title>
    ...
    ========================================================== -->
        ...
        <div class="login-left">
            ...
            <div class="branding">
                ...
                <p>
                    You're almost there. Set a new, secure
                    password to get back into your NACPDEAN
                    membership portal.
                </p>
                ...
                <form method="POST" action="{{ route('password.store') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input id="email" class="form-input" type="email" name="email"
                            value="{{ old('email', $request->email) }}" placeholder="Enter your email address" required
