...
<style>
    ...
    .profile-status-icon.incomplete {
        background: #fef2f2;
        color: #dc2626;
    }

    .profile-status-icon.pending {
        background: #fffbeb;
        color: #d97706;
    }
    ...
    @media (max-width: 768px) {
        ...
        .id-card-actions .nacp-btn-outline {
            width: 100%;
        }
    }
</style>
    ...
    <div class="container-fluid px-4">
        ...
        @elseif (!$profile || $profile->status === 'draft')
            ...
            <div class="profile-status-card">
                ...
                <div class="profile-status-icon incomplete">
                ...
                <p>
                    Your membership payment has been received, but you
                    have not completed your membership profile yet.
        ...
        @elseif ($profile->status === 'submitted')
            ...
            <div class="profile-status-card">
                ...
                <div class="profile-status-icon pending">
                ...
                <p>
                    Your membership profile has been successfully
                    submitted and is currently being reviewed by
                    the NACPDEAN administrator.
                </p>
        ...
        @elseif ($profile->status === 'approved')
            ...
            {{-- =====================================================
                 ...
                 ONLY APPROVED MEMBERS CAN SEE THE INFORMATION BELOW.
            ====================================================== --}}
                    ...
                    <div class="nacp-card">
                        ...
                        <div class="nacp-card-body">
                            ...
                            <div class="id-card-preview">
                                ...
                                <img src="{{ asset(
                                    'backend/assets/img/idcard/idcard1.jpg'
                                ) }}"
                                    alt="NACPDEAN Membership ID Card"
                                    class="nacp-id-card">
