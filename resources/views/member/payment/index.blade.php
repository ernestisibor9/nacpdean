...
@section('member')
    ...
    <div class="container-fluid py-4 payment-page">
        ...
        {{-- ============================================================
        ADMIN MODE BANNER
        Shows only when an admin is paying on behalf of a member
    ============================================================ --}}

        @if (!empty($payingOnBehalfOf))
            <div
                style="
            background: #fef3c7;
        ...
        ">
                ...
                <span style="flex: 1;">
                    ...
                    You are paying the annual membership fee on behalf of
                    <strong>{{ $payingOnBehalfOf->username }}</strong>
                    ({{ $payingOnBehalfOf->phone ?? ($payingOnBehalfOf->email ?? 'no contact') }}).
                    The payment will be recorded against the member's account.
                </span>
    ...
    ============================================================ --}}
        ...
        */
            ...
            $displayMemberType = $memberType ? ucfirst($memberType) : 'N/A';
        @endphp
                    ...
                    @elseif ($membershipFee)
                        ...
                        ================================================= --}}
                            ...
                            <form method="POST" action="{{ route('payment.initialize') }}">
                                ...
                                <input type="hidden" name="payment_option" value="membership">
