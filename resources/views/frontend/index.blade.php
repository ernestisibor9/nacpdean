    ...
    <main class="main">
                    ...
                    <div class="container hero-content">
                        <div class="hero-text">
                            ...
                            <div class="featured-video-wrapper mt-4">
                                <button class="featured-video-btn" data-bs-toggle="modal"
            ...
            <div class="container">
                <div class="row gy-4">
                    <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="100">
                        <div class="service-item position-relative">
                            <div class="text-center mb-3">
                                <img src="assets/img/services/bamboocharcoal.png" alt="Bamboo Charcoal"
                                    width="140px" height="100px">
                            </div>
                            <h4>
                                <a href="" class="stretched-link">Bamboo Charcoal</a>
                            </h4>
                            <p>Bamboo charcoal is a highly porous, eco-friendly carbon material made from mature bamboo
                                plants.</p>
                        </div>
                    </div>
                    <!-- End Service Item -->
                    <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="200">
                        <div class="service-item position-relative">
                            <div class="text-center mb-3">
                                <img src="{{ asset('frontend/assets/img/services/hardwoodcharcoal.png') }}" alt="Hardwood Charcoal"
                                    width="140px" height="100px">
                            </div>
                            <h4>
                                <a href="" class="stretched-link">Hardwood Charcoal</a>
                            </h4>
                            <p>Hardwood charcoal is a type of charcoal made from hardwood trees through a process of
                                pyrolysis.</p>
                        </div>
                    </div>
                    <!-- End Service Item -->
                    <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="300">
                        <div class="service-item position-relative">
                            <div class="text-center mb-3">
                                <img src="assets/img/services/briquettecharcoal.png" alt="Briquette Charcoal"
                                    width="140px" height="100px">
                            </div>
                            <h4>
                    ...
                    <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="400">
                        <div class="service-item position-relative">
                            <div class="text-center mb-3">
                                <img src="{{ asset('frontend/assets/img/services/coconutshellcharcoal.png') }}" alt="Coconut Shell Charcoal"
                                    width="140px" height="100px">
                            </div>
                            <h4>
        ...
        <section id="about" class="about section">
            ...
            <div class="container section-title" data-aos="fade-up">
                ...
                <p>National Association of Charcoal Producers, Dealers, Exporters and Afforestation of Nigeria
                    (NACPDEAN)</p>
            </div>
            <!-- End Section Title -->
            <div class="container">
                <div class="row gy-4">
                    <div class="col-lg-6 position-relative align-self-start" data-aos="fade-up" data-aos-delay="100">
                        <img src="{{ asset('frontend/assets/img/gallery/nacpdeangal11.jpeg') }}" class="img-fluid" alt="">
                    </div>
                    <div class="col-lg-6 content" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <p>
                            <button class="btn btn-success px-4 mt-3" data-bs-toggle="modal"
                ...
                <div class="row gy-4">
                    <div class="col-lg-3 col-md-6">
                        <div class="stats-item d-flex align-items-center w-100 h-100">
                            ...
                            <div>
                                <span data-purecounter-start="0" data-purecounter-end="+37000"
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="stats-item d-flex align-items-center w-100 h-100">
                            <i class="fas fa-users flex-shrink-0"></i>
                            <div>
                                <span data-purecounter-start="0" data-purecounter-end="888"
                                    data-purecounter-duration="1" class="purecounter"></span>
                    ...
                    <div class="swiper-wrapper align-items-center">
                        <div class="swiper-slide">
                            <a class="glightbox" data-gallery="images-gallery"
                                ...
                                <img src="{{ asset('frontend/assets/img/gallery/gallery1.png') }}" class="img-fluid" alt="">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a class="glightbox" data-gallery="images-gallery"
                                href="{{ asset('frontend/assets/img/gallery/gallery2.png') }}">
                                <img src="{{ asset('frontend/assets/img/gallery/gallery2.png') }}" class="img-fluid" alt="">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a class="glightbox" data-gallery="images-gallery"
                                href="{{ asset('frontend/assets/img/gallery/gallery3.jpeg') }}">
                                <img src="{{ asset('frontend/assets/img/gallery/gallery3.jpeg') }}" class="img-fluid" alt="">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a class="glightbox" data-gallery="images-gallery"
                                href="{{ asset('frontend/assets/img/gallery/gallery4.jpg') }}">
                                <img src="{{ asset('frontend/assets/img/gallery/gallery4.jpg') }}" class="img-fluid" alt="">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a class="glightbox" data-gallery="images-gallery"
                                href="{{ asset('frontend/assets/img/gallery/gallery5.jpg') }}">
                                <img src="{{ asset('frontend/assets/img/gallery/gallery5.jpg') }}" class="img-fluid" alt="">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a class="glightbox" data-gallery="images-gallery"
                                href="{{ asset('frontend/assets/img/gallery/gallery6.jpg') }}">
                                <img src="{{ asset('frontend/assets/img/gallery/gallery6.jpg') }}" class="img-fluid" alt="">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a class="glightbox" data-gallery="images-gallery"
                                href="{{ asset('frontend/assets/img/gallery/gallery7.jpeg') }}">
                                <img src="{{ asset('frontend/assets/img/gallery/gallery7.jpeg') }}" class="img-fluid" alt="">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a class="glightbox" data-gallery="images-gallery"
                                href="{{ asset('frontend/assets/img/gallery/gallery8.jpeg') }}">
                                <img src="{{ asset('frontend/assets/img/gallery/gallery8.jpeg') }}" class="img-fluid" alt="">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a class="glightbox" data-gallery="images-gallery"
                                href="{{ asset('frontend/assets/img/gallery/gallery10.png') }}">
                                <img src="{{ asset('frontend/assets/img/gallery/gallery10.png') }}" class="img-fluid" alt="">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a class="glightbox" data-gallery="images-gallery"
                                href="{{ asset('frontend/assets/img/gallery/gallery11.png') }}">
                                <img src="{{ asset('frontend/assets/img/gallery/gallery11.png') }}" class="img-fluid" alt="">
                            </a>
                        </div>
                    </div>
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered">
                ...
                <div class="modal-content border-danger">
                    ...
                    <div class="modal-body text-center p-4">
                        ...
                        <a href="blacklisted-members.php" class="btn btn-danger btn-lg">
        ...
        <div class="whatsapp-widget">
            ...
            <a href="https://wa.me/2348145672358?text=Hello%20I%20would%20like%20to%20know%20more." target="_blank">
