...
<style>
    ...
    .enforcement-section {
        ...
        overflow: hidden;
        border-radius: 24px;
        background: linear-gradient(135deg, #263414, #496b0c);
        padding: 55px;
        color: #fff;
        margin-bottom: 35px;
    }
...
<main class="main compliance-page">
    ...
    <section class="compliance-hero">
        ...
        <div class="container">
            ...
            <div class="compliance-hero-content text-center">
                ...
                <p class="lead max-w-800 mx-auto mt-3">
                    ...
                    Exporters and Afforestation of Nigeria (NACPDEAN), in
                    furtherance of its mandate to regulate the charcoal value
                    chain, promote sustainable forest management, strengthen
                    industry self-regulation, ensure compliance with
                    afforestation obligations, and uphold the resolutions and
                    policies of the Federal Government of Nigeria, hereby issues
                    the following Membership Registration, Afforestation
                    Compliance Fees, Regulatory Charges, Enforcement Procedures
                    and Penalties.
                </p>

                <div class="alert alert-info d-inline-block mt-3 px-4 py-2" role="alert">
                    <i class="fas fa-info-circle me-2"></i>
                    These provisions shall apply to all producers, dealers,
                    suppliers, exporters, transporters and every stakeholder
                    operating within the charcoal industry in Nigeria.
                </div>
    ...
    <section class="compliance-wrapper">
        ...
        <div class="container">
            ...
            ================================================== -->
            <section id="membership" class="compliance-section">
            ...
            <!-- =================================================
                 ...
                 AFFORESTATION
            ================================================== -->
            <section id="afforestation" class="compliance-section">
            ...
            <!-- =================================================
                 ...
                 OPERATIONAL RIGHT
            ================================================== -->
            <section id="operational-right" class="compliance-section">
            ...
            <!-- =================================================
                 ...
                 NON MEMBERSHIP
            ================================================== -->
            <section id="non-membership" class="compliance-section">
            ...
            <!-- =================================================
                 ...
                 VEHICLE / TASK FORCE
            ================================================== -->
            <section id="vehicle" class="compliance-section">
            ...
            <section id="foreign-national"
                ...
                <!-- =================================================
                     FOREIGN NATIONAL SUBSECTION 01
                ================================================== -->
                ...
                <!-- =================================================
                     FOREIGN NATIONAL SUBSECTION 02
                ================================================== -->
                <div class="foreign-subsection">
                ...
                <!-- =================================================
                     FOREIGN NATIONAL SUBSECTION 03
                ================================================== -->
                <div class="foreign-subsection">
            ...
            <!-- =================================================
                 ENFORCEMENT
            ================================================== -->
            <section id="enforcement" class="enforcement-section">
