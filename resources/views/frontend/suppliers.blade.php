...
<style>
    ...
    .suppliers-pagination .page-item .page-link {
        min-width: 40px;
        height: 40px;
    ...
    .suppliers-pagination .page-item .page-link:hover {
        background: #f2f8f5;
    ...
    .suppliers-pagination .page-item.active .page-link {
        background: #198754;
    ...
    .suppliers-pagination .page-item.disabled .page-link {
        background: #f8fafc;
