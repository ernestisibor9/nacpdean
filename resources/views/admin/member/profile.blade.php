...
@section('title')
    NACPDEAN - Complete Member Profile
@endsection
...
@section('admin')
    ...
    @php
        ...
        |--------------------------------------------------------------------------
        |
        | The admin can fill a profile only while it is still editable:
        |
        |   - draft    → normal admin-on-behalf fill
        |   - rejected → member may correct and resubmit
        |
        | Once submitted or approved, the profile becomes read-only.
        |
        */
            ...
            <div class="d-flex flex-column flex-md-row
                ...
                <div>
                    ...
                    <p class="text-muted mb-0">
                        Fill in each section and save before submitting on behalf of the member.
                    </p>
                </div>
            ...
            <div class="card-body">
                ...
                @else
                    <div class="alert alert-light border mt-4 mb-0">
                        ...
                        This information cannot be changed once the profile has been approved.
                    </div>
                @endif
        ...
        <div class="card border-0 shadow-sm mb-4">
            ...
            <div class="card-body">
                ...
                <div class="alert alert-info">
                    ...
                    @else
                        Please upload the documents applicable to the member's membership category.
                    @endif
                </div>
                ...
                @else
                    <div class="alert alert-light border mt-4 mb-0">
                        ...
                        The profile has been approved and documents cannot be changed.
                    </div>
                @endif
                ...
                <div class="card-body text-center">
                    ...
                    @if ($profile->status === 'rejected')
                        <div class="mb-4">
                            ...
                            <h5 class="fw-bold mb-2">Resubmit Application on Behalf of Member</h5>
                            <p class="text-muted mb-3">
                                The previous application was rejected.
                                Please review the feedback, make the necessary
                                corrections and submit the application again.
                            </p>
                    ...
                    @else
                        <h5 class="fw-bold mb-2">Submit Application on Behalf of Member</h5>
                        <p class="text-muted mb-4">
                            Make sure all sections have been saved and all
                            required information has been provided before
                            submitting on behalf of the member.
                        </p>
                    @endif
        ...
        @if ($profile->status === 'submitted')
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body text-center">
                    ...
                    <p class="text-muted mb-0">
                        This profile has been submitted and is currently awaiting
